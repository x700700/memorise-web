...
i18n.use(LanguageDetector).init({
    resources: {
        ...
        he: {
            translations: {
                "signin-title": "היכנס:",
                "signup-title": "הירשם על מנת לייצר אימונים אישיים:",
                "email": "אימייל",
                "nickname": "כינוי",
                "password": "סיסמא",
                "password2": "הקלד סיסמא שנית",
                "signin-btn": "היכנס",
                "signup-btn": "הירשם",
                "signup?": "רוצה אימונים אישיים?",
                "signin?": "כבר רשום ל-memoBool?",
                "signin-done": "שלום",
                "err-requied-field": "שדה חובה",
                "err-name-required": "חובה להזין כינוי",
                "err-name-valid": "הכינוי לא תקין",
                ...
                "err-signup-pass-match": "הסיסמאות לא תואמות",
